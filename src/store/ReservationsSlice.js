...
const SHOW_RESERVATIONS = 'house-rental/reservation/SHOW';
const ADD_RESERVATION = 'house-rental/reservation/ADD';
const DELETE_RESERVATION = 'house-rental/reservation/DELETE';
